...
# Rivya Living Art — Product-UX Benchmark (v6 layer, 2026-08-13)
...
| Area | Best practice (attributed) | What we adapt (Rivya Living Art-specific) |
|---|---|---|
...
| 8 | **Packaging as UX** — photograph the dark-sapphire box once; 'arrives in the Rivya Living Art box' line in the delivery accordion + the frame as the final gallery slide on giftable pieces. | S | product/[slug]/page.tsx (delivery accordion) + one asset |
