...
| `alt-backfill/`                    | Reviewed media-alt batches (Q2) — `batch-01-bundled.json` (124) and `batch-02-bundled.json` (117 remaining bundled images). Apply with `npm run alt:backfill -- <batch> --apply` |
