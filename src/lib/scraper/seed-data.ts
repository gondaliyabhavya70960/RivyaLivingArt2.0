...
export const SEED_SOURCES: SeedSource[] = [
  ...
  // same act as crawling its catalogue, and only the second one needs a review.
  {
    ...
    supply: false,
    enabled: false,
    notes: "Reference: collectible resin furniture, material storytelling.",
  },
  {
    key: "materia-aurea",
    name: "Materia Aurea",
    ...
    supply: false,
    enabled: false,
    notes: "Reference: bespoke commissions, sculptural presentation.",
  },
  {
    ...
    supply: false,
    enabled: false,
    notes: "Reference: Indian luxury collectible furniture, editorial art direction.",
  },
  {
    key: "within-design",
    name: "WITHIN",
    ...
    supply: false,
    enabled: false,
    notes: "Reference: furniture and art presentation, collection storytelling.",
  },
  {
    key: "korepox-arts",
    name: "Korepox Arts",
    ...
    supply: false,
    enabled: false,
    notes: "Competitor: epoxy tables, bespoke furniture, commission CTAs.",
  },
  ...
  // ————————— Tier 2 — Medium (memory & celebration art) —————————
  {
    ...
    supply: false,
    enabled: false,
    notes: "Competitor: varmala preservation, clocks, personalised resin.",
  },
  {
    key: "the-art-galaxy",
    name: "The Art Galaxy",
    ...
    supply: false,
    enabled: false,
    notes: "Competitor: memory-preservation positioning.",
  },
  {
    key: "radhika-art",
    name: "Radhika Art",
    ...
    supply: false,
    enabled: false,
    notes: "Competitor: engagement trays, ring platters, wedding preservation.",
  },
  ...
  // ————————— Tier 3 — Small (personal art & gifting) —————————
  {
    ...
    supply: false,
    enabled: false,
    notes: "Reference: resin jewellery to homewares under one premium identity.",
  },
  {
    ...
    supply: false,
    enabled: false,
    notes: "Competitor: rakhi, jewellery, coasters, broad small-product taxonomy.",
  },
];
