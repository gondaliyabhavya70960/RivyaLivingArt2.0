  ...
  return (
    <button
      ...
      className={cn(
        ...
        "relative flex size-9 cursor-pointer items-center justify-center rounded-sm border border-mineral/20 bg-obsidian/70 text-mineral backdrop-blur-sm transition-[opacity,border-color,background-color] duration-(--dur-micro) ease-(--ease-out) after:absolute after:-inset-1 hover:border-mineral/45 hover:bg-obsidian/85 focus-visible:ring-2 focus-visible:ring-focus focus-visible:ring-offset-2 focus-visible:ring-offset-obsidian motion-reduce:transition-none",
