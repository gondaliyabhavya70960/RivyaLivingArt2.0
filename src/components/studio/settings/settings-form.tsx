    ...
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
      ...
      <FormSection title="Announcement bar">
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          ...
          <p className="text-xs text-muted-foreground sm:col-span-2">
            Leave either blank for no limit on that side. Outside the dates the
            bar shows the stock line rather than going empty. The change appears
            within a few minutes rather than on the minute, because pages are
            cached — right for &ldquo;starts on the 3rd&rdquo;, not for
            &ldquo;at 09:00 sharp&rdquo;.
          </p>
        </div>
        ...
        <div className="space-y-1.5">
          ...
          />
          <p className="text-xs text-muted-foreground">
            Where a chart day starts on the studio dashboard and analytics. IST
            makes &ldquo;today&rdquo; match your working day; past buckets
      ...
      >
        ...
        <div className="space-y-1.5">
          ...
          <p className="text-xs text-muted-foreground">
            Shown on the contact page. A row needs both halves to appear — a day
            with no hours tells a visitor nothing. Leave every row empty to show
            no hours at all, which is what the page did before this existed.
          </p>
        </div>
        ...
        <div className="space-y-1.5">
          ...
          <p className="text-xs text-muted-foreground">
            ...
            studio can keep — it is the first thing a customer measures you by.
          </p>
        </div>
      </FormSection>
